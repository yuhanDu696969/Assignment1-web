            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">联系人登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>性别</label>
                                    <input id="lianxirensexValue" name="lianxirensexValue" class="form-control"
                                           v-model="ruleForm.lianxirensexValue" readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>分类</label>
                                    <input id="lianxirenValue" name="lianxirenValue" class="form-control"
                                           v-model="ruleForm.lianxirenValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="lianxirenAge" name="lianxirenAge" class="form-control"
                                               v-model="ruleForm.lianxirenAge" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="lianxirenEmail" name="lianxirenEmail" class="form-control"
                                               v-model="ruleForm.lianxirenEmail" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="lianxirenQq" name="lianxirenQq" class="form-control"
                                               v-model="ruleForm.lianxirenQq" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="lianxirenZhuzhi" name="lianxirenZhuzhi" class="form-control"
                                               v-model="ruleForm.lianxirenZhuzhi" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="lianxirenDanwei" name="lianxirenDanwei" class="form-control"
                                               v-model="ruleForm.lianxirenDanwei" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.lianxirenContent != null && ruleForm.lianxirenContent != 'null' && ruleForm.lianxirenContent != '') {
            var lianxirenContentUeditor = UE.getEditor('lianxirenContentEditor');
                lianxirenContentUeditor.ready(function () {
                    var mes = '' + ruleForm.lianxirenContent;
                    lianxirenContentUeditor.setContent(mes);
                    lianxirenContentUeditor.setDisabled('fullscreen');
            });
        }
    }
